...
1. Set up your environment by installing the following software:
        ...
        autoconf, automake, bison, bzip2, cmake, doxygen, flex, g++/gcc-c++, gcc, git, gzip, libelf, libusb-dev, make, ncurses, patch, pkg-config, readline, subversion, tar, texinfo, unzip, wget, xz-utils
